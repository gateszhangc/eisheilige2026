...
# 任务1
- 我要创建一个以该网站作eisheilige 2026为关键字网站，使用静态页面就行
-  项目的根路径就是当前目录.不要多一级了
- 使用cavas-design设计logo、favico
- 点击hero中的按钮后跳转至https://graphify.homes/
## 重点
- 禁止没有内容，内容只有seo
...
# 任务4
- 我的域名是eisheilige2026.lol 。利用webapp-launch-analytics这个处理下我的网站。利用seo相关的skill优化下。gsc、ga4、clariy中只接入gsc。
## 重点
